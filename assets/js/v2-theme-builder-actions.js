...
/***/ "../assets/dev/js/editor/v2-theme-builder-actions/hooks/use-document-display-conditions-props.js":
/*!*******************************************************************************************************!*\
  !*** ../assets/dev/js/editor/v2-theme-builder-actions/hooks/use-document-display-conditions-props.js ***!
  \*******************************************************************************************************/
...
exports["default"] = useDocumentDisplayConditionsProps;
var _i18n = __webpack_require__(/*! @wordpress/i18n */ "@wordpress/i18n");
var _documents = __webpack_require__(/*! @elementor/documents */ "@elementor/documents");
var _hierarchyIcon = _interopRequireDefault(__webpack_require__(/*! ../icons/hierarchy-icon */ "../assets/dev/js/editor/v2-theme-builder-actions/icons/hierarchy-icon.js"));
function useDocumentDisplayConditionsProps() {
  const document = (0, _documents.useActiveDocument)();
  const visible = !!elementor.documents.get(document.id)?.config?.theme_builder?.settings?.location;
  return {
    icon: _hierarchyIcon.default,
    title: (0, _i18n.__)('Display Conditions', 'elementor-pro'),
    visible,
    onClick: () => {
...
/***/ "../assets/dev/js/editor/v2-theme-builder-actions/hooks/use-popup-advanced-rules-props.js":
/*!************************************************************************************************!*\
  !*** ../assets/dev/js/editor/v2-theme-builder-actions/hooks/use-popup-advanced-rules-props.js ***!
  \************************************************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
exports["default"] = usePopupAdvancedRulesProps;
var _i18n = __webpack_require__(/*! @wordpress/i18n */ "@wordpress/i18n");
...
function usePopupAdvancedRulesProps() {
  ...
  return {
    ...
    title: (0, _i18n.__)('Advanced Rules', 'elementor-pro'),
    visible,
    onClick: () => {
      $e.route('theme-builder-publish/timing');
    }
  };
}
...
/***/ "../assets/dev/js/editor/v2-theme-builder-actions/hooks/use-popup-triggers-props.js":
/*!******************************************************************************************!*\
  !*** ../assets/dev/js/editor/v2-theme-builder-actions/hooks/use-popup-triggers-props.js ***!
  \******************************************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
exports["default"] = usePopupTriggersProps;
var _i18n = __webpack_require__(/*! @wordpress/i18n */ "@wordpress/i18n");
var _documents = __webpack_require__(/*! @elementor/documents */ "@elementor/documents");
var _triggerIcon = _interopRequireDefault(__webpack_require__(/*! ../icons/trigger-icon */ "../assets/dev/js/editor/v2-theme-builder-actions/icons/trigger-icon.js"));
function usePopupTriggersProps() {
  const document = (0, _documents.useActiveDocument)();
  const visible = 'popup' === document?.type.value;
  return {
    icon: _triggerIcon.default,
    title: (0, _i18n.__)('Triggers', 'elementor-pro'),
    visible,
    onClick: () => {
      $e.route('theme-builder-publish/triggers');
    }
  };
}
...
/***/ "../assets/dev/js/editor/v2-theme-builder-actions/icons/hierarchy-icon.js":
/*!********************************************************************************!*\
  !*** ../assets/dev/js/editor/v2-theme-builder-actions/icons/hierarchy-icon.js ***!
  \********************************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
const HierarchyIcon = _react.default.forwardRef((props, ref) => {
...
var _default = HierarchyIcon;
exports["default"] = _default;

/***/ }),

/***/ "../assets/dev/js/editor/v2-theme-builder-actions/icons/trigger-icon.js":
/*!******************************************************************************!*\
  !*** ../assets/dev/js/editor/v2-theme-builder-actions/icons/trigger-icon.js ***!
  \******************************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
var _extends2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/extends */ "../node_modules/@babel/runtime/helpers/extends.js"));
var _ui = __webpack_require__(/*! @elementor/ui */ "@elementor/ui");
const TriggerIcon = _react.default.forwardRef((props, ref) => {
  return /*#__PURE__*/_react.default.createElement(_ui.SvgIcon, (0, _extends2.default)({
    viewBox: "0 0 24 24"
  }, props, {
    ref: ref
...
/***/ "@elementor/documents":
/*!**********************************************************!*\
  !*** external "__UNSTABLE__elementorPackages.documents" ***!
  \**********************************************************/
/***/ ((module) => {

"use strict";
module.exports = __UNSTABLE__elementorPackages.documents;

/***/ }),

/***/ "@elementor/documents-ui":
/*!************************************************************!*\
  !*** external "__UNSTABLE__elementorPackages.documentsUi" ***!
  \************************************************************/
/***/ ((module) => {

"use strict";
module.exports = __UNSTABLE__elementorPackages.documentsUi;
...
"use strict";
/*!*****************************************************************!*\
  !*** ../assets/dev/js/editor/v2-theme-builder-actions/index.js ***!
  \*****************************************************************/


var _interopRequireDefault = __webpack_require__(/*! @babel/runtime/helpers/interopRequireDefault */ "../node_modules/@babel/runtime/helpers/interopRequireDefault.js");
var _documentsUi = __webpack_require__(/*! @elementor/documents-ui */ "@elementor/documents-ui");
var _useDocumentDisplayConditionsProps = _interopRequireDefault(__webpack_require__(/*! ./hooks/use-document-display-conditions-props */ "../assets/dev/js/editor/v2-theme-builder-actions/hooks/use-document-display-conditions-props.js"));
var _usePopupTriggersProps = _interopRequireDefault(__webpack_require__(/*! ./hooks/use-popup-triggers-props */ "../assets/dev/js/editor/v2-theme-builder-actions/hooks/use-popup-triggers-props.js"));
var _usePopupAdvancedRulesProps = _interopRequireDefault(__webpack_require__(/*! ./hooks/use-popup-advanced-rules-props */ "../assets/dev/js/editor/v2-theme-builder-actions/hooks/use-popup-advanced-rules-props.js"));
_documentsUi.documentOptionsMenu.registerAction({
  name: 'document-display-conditions',
  priority: 10,
  // Before popup triggers.
  useProps: _useDocumentDisplayConditionsProps.default
});
_documentsUi.documentOptionsMenu.registerAction({
  name: 'popup-triggers',
  priority: 20,
  // After display conditions.
  useProps: _usePopupTriggersProps.default
});
_documentsUi.documentOptionsMenu.registerAction({
  name: 'popup-advanced-rules',
  priority: 30,
  // After popup triggers.
  useProps: _usePopupAdvancedRulesProps.default
});
})();

/******/ })()
;
//# sourceMappingURL=v2-theme-builder-actions.js.map